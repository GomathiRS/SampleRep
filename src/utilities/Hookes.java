...
public class Hookes {
   ...
   driver = new ChromeDriver();
	    ...
	    System.out.println("sign_up process succesfully completed ");
    }	
	@Before (order=1)
		...
		System.out.println("----sign_in  scenario Started------");
		    ...
		    Thread.sleep(2000);
		    System.out.println("sign_in process succesfully completed ");
    ...
    public void Sign_out(){
        ...
        System.out.println("sucessfully signed_out");}
